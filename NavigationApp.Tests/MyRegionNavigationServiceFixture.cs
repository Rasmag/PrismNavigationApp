...
{
	[TestClass]
	public class MyRegionNavigationServiceFixture
	{
		...
		public void WhenNavigating_ViewIsActivated()
		{
			...
			MyRegionNavigationService target = new MyRegionNavigationService(serviceLocator, contentLoader, journal);
		...
		public void WhenNavigatingAndViewCannotBeAcquired_ThenNavigationResultHasError()
		{
			...
			MyRegionNavigationService target = new MyRegionNavigationService(serviceLocator, targetHandlerMock.Object, journal);
			target.Region = region;
		...
		public void WhenViewAcceptsNavigationOutAfterNewIncomingRequestIsReceived_ThenOriginalRequestIsIgnored()
		{
			...
			var target = new MyRegionNavigationService(serviceLocator, contentLoader, journal);
			target.Region = region;
		...
		public void WhenTargetViewCreationThrowsWithAsyncConfirmation_ThenExceptionIsProvidedToNavigationCallback()
		{
			...
			var target = new MyRegionNavigationService(serviceLocatorMock.Object, targetHandlerMock.Object, journalMock.Object);
			target.Region = region;
