	...
	public class MenuA : MenuItem
	{
		...
		public MenuA(IRegionManager regionManager, IEventAggregator eventAggregator)
		{
			...
			viewAMenuItem.Command = new DelegateCommand(() =>
			{
				...
				ViewAWorkspaceView workspaceView = new ViewAWorkspaceView();
				workspaceView.Toto = "Tata";
			...
			addViewsMenuItem.Command = new DelegateCommand(() =>
			{
				...
				eventAggregator.GetEvent<OpenWorkspaceEvent>().Publish(workspace);
			});
			...
			{
				eventAggregator.GetEvent<NavigationApp.Infra.Navigation.CloseCurrentWorkspaceEvent>().Publish(null);
			});
